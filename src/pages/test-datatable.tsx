...
const testData: DataTablesData = {
  ...
  'test/filterable.json': {
    rows: [
      { name: 'Stripe', country: 'US', status: 'Active', fee: 2.9 },
      { name: 'PagSeguro', country: 'BR', status: 'Active', fee: 3.49 },
      { name: 'MercadoPago', country: 'AR', status: 'Deprecated', fee: 4.99 },
      { name: 'Adyen', country: 'NL', status: 'Beta', fee: 0.3 },
      { name: 'Klarna', country: 'SE', status: 'Active', fee: 1.5 },
      { name: 'Mollie', country: 'NL', status: 'Beta', fee: 0.25 },
      { name: 'Razorpay', country: 'IN', status: 'Active', fee: 2.0 },
      { name: 'Flutterwave', country: 'NG', status: 'Active', fee: 1.4 },
    ],
  },
  'test/missing.json': undefined as unknown as { rows: [] },
  'test/many-filters.json': {
  ...
  return (
    <DataTablesProvider value={testData}>
      <div style={{ maxWidth: 900, margin: '2rem auto', padding: '0 1rem' }}>
        ...
        <p>
          Columns with <code>filterable: true</code> show a filter input in the
          footer. Non-filterable columns (Fee) have no input.
        </p>
        <DataTable
          src="test/filterable.json"
          columns={[
            {
              key: 'name',
              label: 'Provider',
        ...
        <h2>Many filters (overflow → collapsible)</h2>
        <p>
          Text and number columns (<code>name</code>, <code>version</code>,{' '}
          <code>downloads</code>) are not filterable. Badge/tag/boolean columns
          get dropdowns. Date columns get a date picker. With more than 3
          filters, a "+ N more" toggle appears.
        </p>
        <DataTable
          src="test/many-filters.json"
          columns={[
            { key: 'name', label: 'Name', type: 'text', sortable: true },
